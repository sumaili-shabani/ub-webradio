                                                   ...
                                                   <div class="nk-notification-item dropdown-inner">
                                                        ...
                                                        <div class="nk-notification-content">
                                                            ...
                                                            <div class="nk-notification-time">
                                                                ...
                                                                <p class="pull-right">
                                                                    <span class="pull-right"><a href="<?php echo(base_url()) ?>auditeur/delete_information_notify/favory/<?php echo($key['idfav']) ?>"><i class="fa fa-trash"></i> <?php echo($this->lang->line("menu_view_del")) ?></a></span>
                                                                </p>  
                                                            </div>
