						        ...
						        <div class="nk-split nk-split-page nk-split-md">
						            <div class="nk-split-content nk-block-area nk-block-area-column nk-auth-container w-lg-45">
						                ...
						                <div class="nk-block nk-block-middle nk-auth-body">
						                    ...
						                    <div class="nk-block-head">
						                        <div class="nk-block-head-content">
						                            ...
						                            <div class="nk-block-des" style="margin-top: 10px;">
						                                <p class="text-center"><?php echo($this->lang->line("menu_login_title")) ?></p>
						                            </div>
						                        </div>
						                    </div><!-- .nk-block-head -->
						                     <form method="post" enctype="multipart/form-data" action="<?php echo(base_url()) ?>home/login_validation">
						                        ...
						                        <div class="form-group">
						                            <div class="form-label-group">
						                                ...
						                                <a class="link link-primary link-sm" tabindex="-1" href="<?php echo(base_url()) ?>home/forgot"><?php echo($this->lang->line("menu_forgot_pass")) ?></a>
						                            </div>
						                    ...
						                    <div class="form-note-s2 pt-4"><?php echo($this->lang->line("menu_new_plateform")) ?><a href="<?php echo(base_url()) ?>home/register"><strong><?php echo($this->lang->line("menu_create_account")) ?></strong></a>
						                    </div>
