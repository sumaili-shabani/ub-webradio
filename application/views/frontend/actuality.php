...
<body class="nk-body npc-crypto has-sidebar has-sidebar-fat ui-clean ">
                           		...
                           		<div class="col-md-8 card card-bordered">
				                    ...
				                    <div class="col-md-12 card-inner card-inner-lg">
				                    	...
				                    	<div class="my-3 p-3 bg-white rounded box-shadow">
									        ...
									        <h6 class="border-bottom border-gray pb-2 mb-0 text-center">Les information à la une</h6>
    ...
    <script>
		$(document).ready(function(){
		 ...
		 {
		  $.ajax({
		   url:"<?php echo base_url(); ?>home/pagination_information/"+page,
		   method:"GET",
		   dataType:"json",
		 ...
		 {
			  $.ajax({
			   url:"<?php echo base_url(); ?>home/fetch_search_information",
			   method:"POST",
			   data:{query:query},
			   success:function(data){
		 ...
		 $(document).on('click','.view_info', function(e){
		 	...
		 	$.ajax({
		 		url: "<?php echo base_url(); ?>home/view_fetch_search_information",
		 		method:"POST",
		 		data:{
		 			id_info: id_info
		 		},
