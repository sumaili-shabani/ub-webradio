                ...
                <div class="nk-block nk-block-middle nk-auth-body">
                    ...
                    <div class="nk-block-head">
                        <div class="nk-block-head-content">
                            ...
                            <div class="nk-block-des" style="margin-top: 10px;">
                                <p class="text-center">Si vous avez oublié votre mot de passe, nous vous enverrons par e-mail des instructions pour réinitialiser votre mot de passe.</p>
                            </div>
                        </div>
                    </div><!-- .nk-block-head -->
                    <form method="post" enctype="multipart/form-data" action="<?php echo(base_url()) ?>home/recuperaion_password_auditeur">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="email_aud" class="form-control form-control-lg" id="default-01" placeholder="Entrez votre adresse email" required="">
                        </div>
                        <div class="form-group">
